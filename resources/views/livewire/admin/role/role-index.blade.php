                    ...
                    <div class="relative flex-row flex-1 w-full max-w-full px-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="ml-4">
                                @can('create', \App\Models\Role::class)
                                    <x-button wire:click="selectedItem('create',null)" class="text-white rounded-lg dark:text-gray-300 bg-primary-600 dark:bg-primary-700 hover:bg-primary-700 focus:border-primary-900 focus:ring-primary-300">
                        ...
                        <div class="relative grid grid-cols-6 gap-6 mt-2 ">
                            <div class="col-span-3 md:col-span-2 lg:col-span-2">
                                ...
                                <x-input wire:model.live.debounce.250ms="term" id="search" type="text" class="block w-full mt-1" autocomplete="off" />
                            </div>
                            ...
                            <div class="col-span-3 md:col-span-2 lg:col-span-1">
                                ...
                                <x-select wire:model.live="permissionSearch" wire:key="permissionSearch" class="mt-1">
                                    <option value="">{{ __('app.All') }} {{ __('permission.permissions') }}
                                    </option>
                            ...
                            <thead>
                                <tr class="text-sm font-semibold text-gray-500 border-y ltr:text-left rtl:text-right dark:border-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/30">
                                    ...
                                    <th class="px-2 py-3 text-center">
                                        {{ $trashed ? __('app.deleted_at') : __('app.created_at') }}</th>
                                    ...
                                    <tr class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 hover:dark:text-gray-200 hover:bg-gray-100 hover:dark:bg-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-between gap-1 text-sm text-center">
                                                ...
                                                @if ($trashed)
                                                    @can('restore', $role)
                                                        <x-button wire:click="selectedItem('restore',{{ $role->id }})"
                                                            class="px-2">
                                                ...
                                                @else
                                                    @can('update', $role)
                                                        <x-button wire:click="selectedItem('update',{{ $role->id }})"
                                                            class="px-2">
                                                    ...
                                                    @can('view', $role)
                                                        <x-button wire:click="selectedItem('show',{{ $role->id }})"
                                                            class="px-2">
                                                    ...
                                                    @can('delete', $role)
                                                        <x-button wire:click="selectedItem('delete',{{ $role->id }})"
                                                            class="px-2">
