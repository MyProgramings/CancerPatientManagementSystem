                                ...
                                <tr class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 hover:dark:text-gray-200 hover:bg-gray-100 hover:dark:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-between gap-1 text-sm text-center">
                                            ...
                                            @if($trashed)
                                                @can('restore', $user)
                                                    <x-button wire:click="selectedItem('restore',{{ $user->id }})"
                                                                  class="px-2">
                                            ...
                                            @else
                                                @can('update', $user)
                                                    <x-button wire:click="selectedItem('update',{{ $user->id }})"
                                                                  class="px-2">
                                                ...
                                                @can('view', $user)
                                                    <x-button wire:click="selectedItem('show',{{ $user->id }})"
                                                                  class="px-2">
                                                ...
                                                @can('delete', $user)
                                                    <x-button wire:click="selectedItem('delete',{{ $user->id }})"
                                                                  class="px-2">
